...
# [View / Download](tales_mousinho_fullstack_cv.pdf)
...
| File | Description |
|------|-------------|
| `tales_mousinho_fullstack_cv.tex` | CV source |
| `tales_mousinho_fullstack_cv.pdf` | Compiled PDF (auto-updated by CI) |
| `preview/` | Page preview images (auto-updated by CI) |
| `.github/workflows/build-cv.yml` | Build workflow |
